...
(function($) {
	var pluginName = 'canvasResize',
			methods = {
				...
				rawImageIOSFix: function(ctx, img, sx, sy, sw, sh, dx, dy, dw, dh, vertSquashRatio) {
			...
			reader.onloadend = function(e) {
				...
				img.onload = function(e) {
					...
					$(img).exifLoadFromDataURL(function() {
						...
						// over image size
						//alert("iw: "+iw +", ih: "+ ih);
						//alert(methods.detectSubsampling(img));
						...
						while (sy < ih) {
							...
							var sx = 0;
							//console.log("sy: " + sy + ", ih: " + ih);
							while (sx < iw) {
								//console.log("sx: " + sx + ", iw: " + iw);
						...
						newcanvas = document.getElementById("qr-canvas");
						...
						$this.options.callback(data, width, height, blob, newctx);
						//console.log(data);
						// CALLBACK
